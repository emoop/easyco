...
/** The drill-down view behind ProductGroup's product-count column — mirrors SeasonResource\Pages\RelatedProducts exactly. */
class RelatedProducts extends Page implements HasTable
{
    ...
    public function mount(int|string $record): void
    {
        ...
        abort_unless(ProductGroupResource::canView($this->record), 403);
    }
    ...
    {
        return $table
            ->query(ProductModel::query()->where('product_group_id', $this->record->id))
            ->columns([
            ...
            ->toolbarActions([
                BulkAction::make('detach')
                    ...
                    ->visible(fn (): bool => ProductGroupResource::canEdit($this->record))
                    ->action(function (Collection $records): void {
                        $this->runBulkUnlink(
                            $records->pluck('id'),
                            CatalogLookupKind::PRODUCT_GROUP,
